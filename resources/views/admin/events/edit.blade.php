            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('event.update',$course->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <textarea name="description" class="form-control" cols="30" rows="3">{{ $course->description }}</textarea>
                                    </div>
                                </div>
